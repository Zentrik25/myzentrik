...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Get a free quote within 24 hours for custom software, WhatsApp chatbots, and AI agents. Based in Zimbabwe, serving clients globally.',
    url: 'https://www.zentriksolutions.com/contact',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Contact Zentrik Solutions' }],
  },
  twitter: {
...
const localBusinessSchema = {
  ...
  description: 'Zimbabwe-based software company building custom software, WhatsApp chatbots, and AI agents for businesses across Africa and globally.',
  priceRange: '$150 – $1500+',
}
